...
INSERT INTO `products` (`id`, `supplier_id`, `name`, `barcode`, `price`, `cost_price`, `category`, `stock`, `description`, `image`, `created_at`) VALUES
(5, NULL, 'Pollo', NULL, 13.91, 0.00, 'Carnes Rojas', 20, 'Carne rojita', '1932d1225e35f0ad1708bb97.png', '2026-01-15 22:29:03'),
(6, NULL, 'Arroz', NULL, 23.20, 0.00, 'Granos', 0, 'granos', 'imagen_2026-01-16_004122429.png', '2026-01-16 05:41:23'),
(7, NULL, 'chocolate', NULL, 0.50, 0.00, 'dulces', 0, 'Dulces', 'c517e7aab06a17a0cbccb41c.png', '2026-04-01 22:39:35'),
(8, 2, 'Coca-Cola 2.5L', '853211005148', 2.50, 1.50, 'Bebidas', 67, 'Refresco de cola familiar', '620e767f925e901578b7f13e.png', '2026-05-07 05:41:53'),
(9, NULL, 'Agua Mineral 500ml', NULL, 0.50, 0.00, 'Bebidas', 96, 'Agua sin gas', '847630c5a2709fa9c921a209.png', '2026-05-07 05:41:53'),
(10, NULL, 'Jugo de Naranja 1L', NULL, 1.20, 0.00, 'Bebidas', 30, 'Jugo natural pasteurizado', 'catalog-jugo-naranja-1l.jpg', '2026-05-07 05:41:53'),
(11, NULL, 'Leche Entera 1L', NULL, 0.90, 0.00, 'Lácteos', 40, 'Leche de vaca fortificada', 'catalog-leche-entera-1l.jpg', '2026-05-07 05:41:53'),
(12, NULL, 'Yogurt de Fresa 1kg', NULL, 1.80, 0.00, 'Lácteos', 18, 'Yogurt cremoso con trozos', 'catalog-yogurt-fresa-1kg.jpg', '2026-05-07 05:41:53'),
(13, NULL, 'Queso Fresco 500g', NULL, 3.50, 0.00, 'Lácteos', 15, 'Queso artesanal', 'catalog-queso-fresco-500g.jpg', '2026-05-07 05:41:53'),
(14, NULL, 'Arroz 5kg', NULL, 4.50, 0.00, 'Abarrotes', 60, 'Arroz grano largo', 'catalog-arroz-5kg.jpg', '2026-05-07 05:41:53'),
(15, NULL, 'Aceite Girasol 1L', NULL, 2.10, 0.00, 'Abarrotes', 35, 'Aceite vegetal refinado', 'catalog-aceite-girasol-1l.jpg', '2026-05-07 05:41:53'),
(16, NULL, 'Pan de Molde', NULL, 1.50, 0.00, 'Panadería', 20, 'Pan blanco tajado', 'catalog-pan-de-molde.jpg', '2026-05-07 05:41:53'),
(17, NULL, 'Café Molido 250g', NULL, 3.20, 0.00, 'Abarrotes', 25, 'Café de altura seleccionado', 'catalog-cafe-molido-250g.jpg', '2026-05-07 05:41:53'),
(18, NULL, 'Gomitas', NULL, 0.50, 0.00, 'Gomitas S.A', 15, 'Gomitas', '2c44ea8647a8f84f699d5404.png', '2026-06-23 05:32:18'),
(19, NULL, 'Mayonesa', NULL, 1.00, 0.00, 'Condimentos', 24, 'Mayonesa', '2b18b743c45112dd1cb8b386.png', '2026-06-23 05:37:19'),
(22, 2, 'Coca Cola 3Litros', 'SC050', 5.00, 2.00, 'Bebidas', 20, '', '', '2026-06-24 06:33:29');
...
(33, 5, NULL, 'CONSUMIDOR_FINAL', NULL, NULL, NULL, NULL, NULL, 13.91, 2.09, 16.00, '2026-06-24 01:11:49');
...
INSERT INTO `suppliers` (`id`, `company_name`, `contact_name`, `email`, `ruc`, `phone`, `address`, `created_at`, `updated_at`) VALUES
(2, 'Coca-Cola Company', 'Departamento de Ventas', 'contacto@coca-cola.com', '1790016919001', '(02) 397-2600', 'Quito, Pichincha, Ecuador', '2026-06-24 05:21:31', '2026-06-24 05:21:31');
